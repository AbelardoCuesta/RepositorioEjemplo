...
class Usuario(db.Model):
    ...
    cancionesCompartidas = db.relationship('CancionCompartida', cascade='all, delete, delete-orphan')
...
class CancionCompartida(db.Model):
    usuarioCompartir=db.Column(db.Integer, db.ForeignKey("usuario.id"),primary_key=True)
    cancion=db.Column(db.Integer, db.ForeignKey("cancion.id"),primary_key=True)
    fecha=db.Column(db.DateTime)

class CancionCompartidaSchema(SQLAlchemyAutoSchema):
    class Meta:
         model = CancionCompartida
