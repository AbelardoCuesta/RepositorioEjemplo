...
import { CancionComentarioComponent } from './cancion/cancion-comentario/cancion-comentario.component';
...
const routes: Routes = [
  ...
  {
    path: 'albumes/compartir/:albumId/:userId/:userToken',
  ...
  {
    path: 'canciones/comentario/:cancionId/:userId/:userToken',
    component: CancionComentarioComponent,
    canActivate: [AuthGuardService]
  }
];
